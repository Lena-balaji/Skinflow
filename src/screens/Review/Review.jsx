...
const Review = () => {
  ...
  const [reviews, setReviews] = useState([
    { name: 'Mithuna', rating: 5, comment: 'Amazing product! Highly recommend!' },
    { name: 'Rama', rating: 4, comment: 'Great service' },
    { name: 'lena', rating: 4, comment: 'Great service,' },
    { name: 'ajna', rating: 3, comment: 'It suchly nice' },
