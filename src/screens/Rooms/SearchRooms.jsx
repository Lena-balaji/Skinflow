...
const SearchRooms = () => {
    ...
    return (
        <div>
            <div class="container">
                <center>
                    <h1 className='featured-heading'> Search Product </h1>
                </center>
                                    ...
                                    <div class="slide slide2">
                                        ...
                                        <div class="content">
                                            ...
                                            <Link to={`/singleRoom/2`}>
                                                <p>Click to book your product of your own choice </p>
                                            </Link>
                                            {/* <p>Click to book your product of your own choice </p> */}
                                ...
                                <div class="card ">
                                    ...
                                    <div class="slide slide2">
                                        ...
                                        <div class="content">
                                            ...
                                            <Link to={`/singleRoom/4`}>
                                            <p>Click to book your roomproduct of your own choice </p>
                                        </Link>
                                            {/* <p>Click to book your room of your own choice </p> */}
